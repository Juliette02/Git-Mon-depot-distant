...
<form method="POST" action="login_script.php" class="row align-center">
    <div class="form-group offset-4 col-4 pt-5">
        ...
        <legend class="bg-success text-center font-weight-bold"> Utilisateur </legend><br>
        ...
        <input type="submit" class="btn btn-success" id="inscrit" name="inscrit" value="Se connecter">
        <button onclick="return deletes(form)" class="btn btn-success">
        <?php 
            echo '<a href="script_login_delete.php" "onclick="deletes(form);"></a>' 
        ?>
        Supprimer</button>
        <a href="V_Record.php" class="btn btn-success" >Retour</a>
